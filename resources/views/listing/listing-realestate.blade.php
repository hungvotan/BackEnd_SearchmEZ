...
@section('title', 'Real Estate | Listing')
...
@section('content')
    <!-- listing Real Estate  -->
    <section id="listing-Real Estate">
        @if (session('status'))
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Real Estate | Listing</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="price_per">Price per 24hrs (P) <span class="text-red">(*)</span> </label>
                                                    <input type="number" name="price_per" id="price_per" class="form-control" placeholder="Price per 24hrs (P)" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="custom-control custom-control-warning custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="Couples" name="realestate_checkbox[]" value="Couples">
                                                    <label class="custom-control-label" for="Couples">Couples</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="custom-control custom-control-warning custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="Students" name="realestate_checkbox[]" value="Students">
                                                    <label class="custom-control-label" for="Students">Students</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="custom-control custom-control-warning custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="Pets" name="realestate_checkbox[]" value="Pets">
                                                    <label class="custom-control-label" for="Pets">Pets</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="custom-control custom-control-warning custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="Furnished" name="realestate_checkbox[]" value="Furnished">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="bedroom">Bedroom <span class="text-red">(*)</span> </label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="bathroom">Bathroom <span class="text-red">(*)</span> </label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="car_parks">Car parks <span class="text-red">(*)</span> </label>
                                                    <select class="form-control" id="car_parks" name="car_parks" required>
                                                        <option value="">Please choose ...</option>
                                                        <option value="car_parks">car_parks</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="year_built">Year built <span class="text-red">(*)</span> </label>
                                                    <select class="form-control" id="year_built" name="year_built" required>
                                                        <option value="">Please choose ...</option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="open_house">Open house <span class="text-red">(*)</span> </label>
                                                    <select class="form-control" id="open_house" name="open_house" required>
                                                        <option value="">Please choose ...</option>
                                                        <option value="bedroom">open_house</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="land_area">Land area <span class="text-red">(*)</span> </label>
                                                    <input type="number" name="land_area" id="land_area" class="form-control" placeholder="Land area" required />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="floor_area">Floor area <span class="text-red">(*)</span> </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label" for="roof_materials">Roof materials <span class="text-red">(*)</span> </label>
                                                    <input type="text" name="roof_materials" id="roof_materials" class="form-control" placeholder="Roof materials" required />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label" for="floor_materials">Floor materials <span class="text-red">(*)</span> </label>
                                                    <input type="text" name="floor_materials" id="floor_materials" class="form-control" placeholder="Floor materials" required />
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="form-label" for="wall_materials">Wall materials <span class="text-red">(*)</span> </label>
                                                    <input type="text" name="wall_materials" id="wall_materials" class="form-control" placeholder="Wall materials" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="amenities">Amenities <span class="text-red">(*)</span> </label>
