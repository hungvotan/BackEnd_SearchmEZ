            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Coupon | Listing</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="deal_ends">Deal ends <span class="text-red">(*)</span> </label>
                                                    <input type="date" name="deal_ends" id="deal_ends" class="form-control" placeholder="Deal ends" required />
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="coupon_type">Coupon Type <span class="text-red">(*)</span> </label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="coupon_value">Coupon value <span class="text-red">(*)</span> </label>
                                                    <input type="number" name="coupon_value" id="coupon_value" class="form-control" placeholder="Coupon value" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="custom-control custom-control-warning custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="Enable_Discussion" name="checkbox[]" value="Enable_Discussion">
                                                    <label class="custom-control-label" for="Enable_Discussion">Enable Discussion</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="custom-control custom-control-warning custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="Enable_Review" name="checkbox[]" value="Enable_Review">
                                                    <label class="custom-control-label" for="Enable_Review">Enable Review</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="custom-control custom-control-warning custom-checkbox">
