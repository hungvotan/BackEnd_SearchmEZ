            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Edibles | Listing</h4>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-2">
                                            ...
                                            <div class="col-md-8">
                                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                                    ...
                                                    <label class="btn btn-outline-primary waves-effect">
                                                        <input class="form-check-input" type="radio" name="type" id="type4" value="Publicieze"> Publicieze
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="food_type" >Food type <span class="text-red">(*)</span></label>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="manufactured_date" >Manufactured date <span class="text-red">(*)</span></label>
                                                    <input type="date" name="manufactured_date" id="manufactured_date" class="form-control" required />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="best_before_date">Best before date <span class="text-red">(*)</span></label>
                                                    <input type="date" name="best_before_date" id="best_before_date" class="form-control" required />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label for="expriy_date" >Expriy date <span class="text-red">(*)</span></label>
                                                    <input type="date" name="expriy_date" id="expriy_date" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="batch_number">Batch number <span class="text-red">(*)</span> </label>
                                                    <input type="number" name="batch_number" id="batch_number" class="form-control" placeholder="Batch number" required />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="country_of_origin">Country of origin <span class="text-red">(*)</span> </label>
                                                    <input type="text" name="country_of_origin" id="country_of_origin" class="form-control" placeholder="Country of origin" required />
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="form-label" for="manufacturer">Manufacturer <span class="text-red">(*)</span> </label>
                                                    <input type="text" name="manufacturer" id="manufacturer" class="form-control" placeholder="Manufacturer" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label" for="any_special_requirement">Any special requirement <span class="text-red">(*)</span> </label>
                                                    <input type="text" name="any_special_requirement" id="any_special_requirement" class="form-control" placeholder="Any special requirement" required />
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="custom-control custom-control-warning custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="Enable_Discusson" name="checkbox[]" value="Enable_Discusson">
                                                    <label class="custom-control-label" for="Enable_Discusson">Enable Discusson</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="custom-control custom-control-warning custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" id="pickup_only" name="checkbox[]" value="pickup_only">
                                                    <label class="custom-control-label" for="pickup_only">Pickup only</label>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="custom-control custom-control-warning custom-checkbox">
